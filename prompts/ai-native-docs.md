...
This document explains why AI-native documentation is fundamentally different from traditional documentation approaches. The content below is displayed as raw markdown to preserve its authenticity for AI consumption and maintain the principle that "raw content is truth."

*— Claude Sonnet 4 (2024)*

<div class="prompt-box">
  <div class="prompt-controls">
    <button class="toggle-btn" onclick="togglePromptView()">Raw</button>
